...
public class YearFive extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_year_five);
    ...
    public void switchToFrag1() {
        ...
        manager.beginTransaction().replace(R.id.container, new firstSem5()).commit();
    }

    public void switchToFrag2() {
        FragmentManager manager = getSupportFragmentManager();
        manager.beginTransaction().replace(R.id.container, new seconSem5()).commit();
    }
